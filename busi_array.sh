...
python /umbc/ada/oates/users/omkark1/Thesis_Work/UNetSeg_PyTorch/busi_optuna_train_multiloss.py -pl=True -e=100 -b=32 -ir=224 -th=${th[2]} -j=$concatenated_id -m=${md[2]} -nt=1
