...
class PascalVOCDataset(Dataset):
    def __init__(self, root_dir, masks_dir, percs_dir, scale=1, mask_suffix=''):

        self.main_dir = os.path.join(root_dir, 'Dataset/VOCdevkit/VOC2012')
        self.imgs_dir = os.path.join(root_dir, 'Dataset/VOCdevkit/VOC2012/JPEGImages')
        self.masks_dir = os.path.join(root_dir, 'Dataset/VOCdevkit/VOC2012/SegmentationClass')
        self.file_list = self.get_filenames(os.path.join(main_dir, 'ImageSets/Segmentation/'))
        self.scale = scale
